...
/// <summary>Soft-delete da OS (só antes da aprovação). Equivalente ao DELETE do legado.</summary>
internal sealed class DeactivateServiceOrderHandler : ICommandHandler<DeactivateServiceOrderCommand>
{
    private readonly IServiceOrderRepository _repository;
    private readonly ICurrentActor _currentActor;
    private readonly TimeProvider _timeProvider;

    public DeactivateServiceOrderHandler(
    ...
    public async Task<Result> Handle(DeactivateServiceOrderCommand command, CancellationToken ct)
    {
        ...
        var result = order.Deactivate(_currentActor.Current, _timeProvider.GetUtcNow().UtcDateTime);
